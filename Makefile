...
SERVICE_CAPS = eapearsonDemoGenomeEditClassification
SPEC_FILE = eapearsonDemoGenomeEditClassification.spec
URL = https://kbase.us/services/eapearsondemogenomeeditclassification
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
